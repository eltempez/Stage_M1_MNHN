...
# paths
bowtie_folder = "/home/eliotttempez/Documents/tests/outputs_mcf10_snk/mapping/mapped/concord/"
kraken_file = "/home/eliotttempez/Documents/tests/kraken/3/kraken_output.kraken2"
...
with open("./mismatchs_bt_kr.txt", "w") as f_out:
    f_out.write(f"total concordant reads\t{len(global_dict)}\n")
